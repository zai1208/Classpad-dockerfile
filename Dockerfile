...
RUN apt-get update --yes && apt-get upgrade --yes && apt-get install git gcc g++ libgmp-dev libmpfr-dev texinfo make curl xz-utils bzip2 libc6 libstdc++6 zstd zlib1g-dev --yes
